...
export function ColorMixer() {
  ...
  return (
    <section className="control-group color-mixer">
      ...
      <button className="button" aria-pressed={studio.colorPicking} onClick={()=>{studio.setColorPicking(!studio.colorPicking);studio.setCompareMode("off");useEditorStore.getState().setMaskEditing(false);}}><T text={studio.colorPicking?"Cancel color picker":"Pick color from image"}/></button>
