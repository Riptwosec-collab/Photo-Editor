...
export function CloudAiPanel() {
  ...
  const [capabilities, setCapabilities] = useState<Record<string,{ enabled: boolean; missing?: string[]; cost: string; reserveCents:number; dailyBudgetCents:number; dailyJobs:number }>>({});
